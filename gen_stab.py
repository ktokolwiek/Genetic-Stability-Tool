    ...
    if MODE == 'g':
        ...
        for i in range(NO_SEQUENCES):
            print SeqRecord(Seq(best[i]),
                   ...
                   description="Achieved by Genetic Algorithm").format('fasta')
            print ""
        print ""
        best.append(source)
        ...
        print SeqRecord(Seq(bestresult),
                   id=fasta_id+" copy",
                   description="Achieved by Best Codon method").format('fasta')
    elif MODE == 'r':
        #run random codon
        random.seed()
        ...
        print SeqRecord(Seq(randresult),
                   id=fasta_id+" copy",
                   description="Achieved by Random Codon method").format('fasta')
